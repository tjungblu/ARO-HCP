...
param roles = [
  {
    roleName: 'Azure Red Hat OpenShift Managed Identity Role - Dev'
    roleDescription: 'Enables the cluster service to access the virtual network of a customer and update the network configuration.'
    actions: [
